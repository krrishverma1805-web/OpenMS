...
namespace OpenMS
{
  ...
  {
    std::string rscript_executable = static_cast<std::string>(rscript_executable_);
    ...
    if (!file_models.empty() || !file_models_plot.empty())
    {
      ...
      {
        if (!RWrapper::runScript("InternalCalibration_Models.R", std::vector<std::string>{static_cast<std::string>(out_table), static_cast<std::string>(file_models_plot)}, rscript_executable))
        {
    ...
    {
      if (!RWrapper::runScript("InternalCalibration_Residuals.R", std::vector<std::string>{static_cast<std::string>(out_table_residuals), static_cast<std::string>(file_residuals_plot)}, rscript_executable))
      {
